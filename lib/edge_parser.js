...
module.exports = function EdgeParser(){
	...
	function saveAction(fnName){
		return function(compId, symbolName, elementSelector_or_null, eventName, eventFunction){
			...
			_compositions[compId].definition.actions[fnName] = _compositions[compId].definition.actions[fnName] || {};
			_compositions[compId].definition.actions[fnName][symbolName] = _compositions[compId].definition.actions[fnName][symbolName] || {};
			_compositions[compId].definition.actions[fnName][symbolName][elementSelector_or_null] = _compositions[compId].definition.actions[fnName][symbolName][elementSelector_or_null] || {};
			_compositions[compId].definition.actions[fnName][symbolName][elementSelector_or_null][eventName] = eventFunction;
